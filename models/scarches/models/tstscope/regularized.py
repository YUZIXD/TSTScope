from  .trainer import tcrVAETrainer
...
class tstscopeTrainer(tcrVAETrainer):
    ...
    def loss(self, total_batch=None):
        ...
        gene_recon_loss, tcr_recon_loss, tcr_hsic_loss, kl_loss, align_loss = self.model(**total_batch)
        ...
        loss = gene_recon_loss + tcr_recon_loss + self.calc_alpha_coeff()*kl_loss + weighted_hsic + self.align_weight*align_loss

        self.iter_logs["loss"].append(loss.item())
        self.iter_logs["unweighted_loss"].append((gene_recon_loss + tcr_recon_loss + kl_loss + tcr_hsic_loss + align_loss).item())
        ...
        self.iter_logs["align_loss"].append(align_loss.item())
