...
from ._utils import make_dataset, make_tcr_dataset, custom_collate, print_progress
...
class Trainer:
    ...
    def __init__(self,
        ...
        self.device_name = kwargs.pop("device", "cuda:3")
        ...
        if torch.cuda.is_available():
            ...
            logging.info(f"GPU available: True, GPU used: True, Device: {self.device}")
        else:
    ...
    def train(self,
        ...
        for self.epoch in range(n_epochs):
            ...
            # time_end = time.time()  
            # print(f'Epoch Time loss: {time_end-time_start:.4f}s')
